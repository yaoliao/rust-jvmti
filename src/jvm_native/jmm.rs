...
use jvm_native::bitfield::__BindgenBitfieldUnit;
use jvm_native::jni::*;
...
pub const JMM_VERSION_3: ::std::os::raw::c_uint = 537067520;
pub const JMM_VERSION: ::std::os::raw::c_uint = 537067520;
#[repr(C)]
#[repr(align(4))]
...
pub struct jmmInterface_1_ {
    ...
    pub GetPeakMemoryPoolUsage:
        ::std::option::Option<unsafe extern "C" fn(env: *mut JNIEnv, pool: jobject) -> jobject>,
    pub GetOneThreadAllocatedMemory:
